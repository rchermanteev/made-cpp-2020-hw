...
public:
	...
	Node(T&& value, Node<T>* next, Node<T>* prev): val(std::move(value)), next(next), prev(prev) {};
	Node(const Node<T>& other): val(other.val), next(other.next), prev(other.prev) {};
	~Node() {};
...
public:
    ...
    public:    
        ...
        iterator operator++(int) { iterator t(*this); t = t->next; return t; };
        reference operator*() const { return node->val; };
		pointer operator->() const { return &(node->val); };
        iterator& operator--() { node = node.prev; return *this; };
        iterator operator--(int) { iterator t(*this); t = t.prev; return t; };
    ...
    public:    
        ...
        const_iterator& operator=(const_iterator& it) { node = it.node; return *this; };
        const_iterator& operator++() { node = node->next; return *this; }
        const_iterator operator++(int) { const_iterator t(*this); t = t->next; return t; };
        ...
        const_iterator operator--(int) { const_iterator t(*this); t = t.prev; return t; };
